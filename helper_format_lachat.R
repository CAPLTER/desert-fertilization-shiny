#' @title Helper: format_lachat 
#'
#' @description Function to format resin-related Lachat data. Inputs include the
#'   Lachat data (R object) and name of file from which the Lachat data were
#'   derived. As much as possible, the Sample ID field (basically the identify
#'   of the collection site (e.g., LDP) and type (e.g., IP)) is standardized
#'   based on observed patterns to facilitate a match between the collector id
#'   entered as metadata (ideally the Lachat Sample ID for the unknown samples
#'   is from bar code so always the same (but, yeah, right)). The purpose of the
